...
# -*- coding:utf-8 -*-
#-------------------------------------------------------------------------------
# File Name:   pyunit_testmodule.py
# Purpose:     Create test suite from a test module  
#
# Author:      Ke Wang
#
# Created:     2019-11-04
...
class WebTest2(unittest.TestCase):
...
def main():
    ...
    suite = unittest.TestLoader().loadTestsFromModule('pyunit_testmodule.py')
